				...
				if(!entitiesInBox.isEmpty()){
					for(Entity e : entitiesInBox){
						if (e instanceof EntityHanging){
							...
							entNBT.setInteger("TileX", ((EntityHanging) e).func_174857_n().getX() - structureBoundingBox.minX);
							entNBT.setInteger("TileY", ((EntityHanging) e).func_174857_n().getY() - structureBoundingBox.minY);
							entNBT.setInteger("TileZ", ((EntityHanging) e).func_174857_n().getZ() - structureBoundingBox.minZ);
