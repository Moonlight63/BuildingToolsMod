	...
	public void perform(){
		...
		if(!currentlyCalculating){
			...
			if(!selectionSet.isEmpty()){
				...
				if(saveUndo)
					BuildingTools.getPlayerRegistry().getPlayer(entity).get().tempUndoList.addAll(MiscUtils.CalcUndoList(
							BuildingTools.getPlayerRegistry().getPlayer(entity).get().pendingChangeQueue.blockpos, world));
